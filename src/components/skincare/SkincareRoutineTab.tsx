...
export function SkincareRoutineTab() {
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-40">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={productUsage} cx="50%" cy="50%" innerRadius={30} outerRadius={60} dataKey="value">
                  ...
                  <div key={entry.id} className="flex items-start gap-3 p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <p className="text-sm font-medium text-foreground capitalize">{entry.routineType} Routine</p>
                        <Badge variant="secondary" className={`text-xs ${condStyle?.color}`}>{condStyle?.label}</Badge>
                      </div>
                      ...
                      {entry.products.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          ...
                          {entry.products.length > 3 && (
                            <Badge variant="outline" className="text-xs">+{entry.products.length - 3}</Badge>
                          )}
                        </div>
                      )}
                    </div>
