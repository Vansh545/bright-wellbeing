        ...
        <motion.div variants={itemVariants}>
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-4">
              ...
              <motion.div className="grid grid-cols-2 gap-4" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
                <div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="space-y-3">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                    ...
                    {exercisePlan && (
                      <motion.div className="markdown-content" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <CardContent className="space-y-3 max-h-[400px] overflow-y-auto">
              <AnimatePresence>
                {sortedWorkouts.map((workout, index) => (
                  ...
                  >
                    <motion.div className={`h-10 w-10 rounded-lg ${getTypeColor(workout.type)} flex items-center justify-center`} whileHover={{ rotate: 10 }}>
                      <Dumbbell className="h-5 w-5 text-primary-foreground" />
                    </motion.div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <p className="text-sm font-medium text-foreground capitalize">{workout.type}</p>
                        <Badge variant="secondary" className="text-xs">{workout.duration} min</Badge>
                      </div>
